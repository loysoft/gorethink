...
func (suite *JoinsSuite) TestCases() {
    ...
    var tbl3 r.Term = r.DB("test").Table("test3")
    ...
    var ij r.Term = tbl.InnerJoin(tbl2, func(x r.Term, y r.Term) interface{} { return x.AtIndex("a").Eq(y.AtIndex("b"))}).Zip()
    ...
    var oj r.Term = tbl.OuterJoin(tbl2, func(x r.Term, y r.Term) interface{} { return x.AtIndex("a").Eq(y.AtIndex("b"))}).Zip()
    ...
    blah = maybeRun(otbl.OrderBy(r.Desc("id")).EqJoin(r.Row.AtIndex("id"), otbl2, r.EqJoinOpts{Ordered: true, }).Zip(), nil, r.RunOpts{});
    ...
    blah = maybeRun(otbl.OrderBy("id").EqJoin(r.Row.AtIndex("a"), otbl2, r.EqJoinOpts{Ordered: true, }).Zip(), nil, r.RunOpts{});
    ...
    var left r.Term = r.Expr([]interface{}{map[interface{}]interface{}{"a": 1, }, map[interface{}]interface{}{"a": 2, }, map[interface{}]interface{}{"a": 3, }})
    ...
    var right r.Term = r.Expr([]interface{}{map[interface{}]interface{}{"b": 2, }, map[interface{}]interface{}{"b": 3, }})
