...
func (suite *TimesTimeArithSuite) SetupTest() {
	fmt.Println("Setting up TimesTimeArithSuite")
...
func (suite *TimesTimeArithSuite) TearDownSuite() {
	fmt.Println("Tearing down TimesTimeArithSuite")
...
func (suite *TimesTimeArithSuite) TestCases() {
	fmt.Println("Running TimesTimeArithSuite: Test basic time arithmetic")



	// times/time_arith.yaml line #3
	// rt1 = 1375147296.681
	fmt.Println("Possibly executing: var rt1 float64 = 1375147296.681")
	...
	// rt2 = 1375147296.682
	fmt.Println("Possibly executing: var rt2 float64 = 1375147296.682")
	...
	// rt3 = 1375147297.681
	fmt.Println("Possibly executing: var rt3 float64 = 1375147297.681")
	...
	// rt4 = 2375147296.681
	fmt.Println("Possibly executing: var rt4 float64 = 2375147296.681")
	...
	// rts = [rt1, rt2, rt3, rt4]
	fmt.Println("Possibly executing: var rts []interface{} = []interface{}{rt1, rt2, rt3, rt4}")
	...
	// t2 = r.epoch_time(rt2)
	fmt.Println("Possibly executing: var t2 r.Term = r.EpochTime(rt2)")
	...
	// t3 = r.epoch_time(rt3)
	fmt.Println("Possibly executing: var t3 r.Term = r.EpochTime(rt3)")
	...
	// t4 = r.epoch_time(rt4)
	fmt.Println("Possibly executing: var t4 r.Term = r.EpochTime(rt4)")
	...
	fmt.Println("Possibly executing: var ts r.Term = r.Expr([]interface{}{t1, t2, t3, t4})")
...

	{
		...
		fmt.Println("About to run line #17: r.Sub(t2, t1).Mul(1000).Do(func(x r.Term) interface{} { return r.Gt(x, 0.99).And(r.Lt(x, 1.01))})")
...

	{
		...
		fmt.Println("About to run line #20: r.Sub(t3, t1)")
...

	{
		...
		fmt.Println("About to run line #23: r.Sub(t4, t1)")
...

	{
		...
		fmt.Println("About to run line #28: r.Sub(t1, t2).Mul(1000).Do(func(x r.Term) interface{} { return r.Lt(x, -0.99).And(r.Gt(x, -1.01))})")
...

	{
		...
		fmt.Println("About to run line #31: r.Sub(t1, t3)")
...

	{
		...
		fmt.Println("About to run line #34: r.Sub(t1, t4)")
...

	{
		...
		fmt.Println("About to run line #39: ts.Map(func(x r.Term) interface{} { return r.Add(t1, r.Sub(x, t1))}).Map(func(x r.Term) interface{} { return x.ToEpochTime()})")
...

	{
		...
		fmt.Println("About to run line #43: ts.Map(func(x r.Term) interface{} { return r.Add(t1, x).Sub(t1)}).Map(func(x r.Term) interface{} { return x.ToEpochTime()})")
...

	{
		...
		fmt.Println("About to run line #47: ts.Map(func(x r.Term) interface{} { return r.Sub(t1, r.Sub(t1, x))}).Map(func(x r.Term) interface{} { return x.ToEpochTime()})")
...
[false, true,  true,  false, true,  false]]]) */
		...
		fmt.Println("About to run line #52: ts.Map(func(x r.Term) interface{} { return ts.Map(func(y r.Term) interface{} { return []interface{}{r.Lt(x, y), r.Le(x, y), r.Eq(x, y), r.Ne(x, y), r.Ge(x, y), r.Gt(x, y)}})})")
	...
	fmt.Println("Possibly executing: var datum_types r.Term = r.Expr([]interface{}{nil, true, false, 1, '1', []interface{}{1}, map[interface{}]interface{}{'1': 1, }, r.Binary([]byte{})})")
...
[false, false, false, false]]]) */
		...
		fmt.Println("About to run line #99: ts.Map(func(a r.Term) interface{} { return ts.Map(func(b r.Term) interface{} { return ts.Map(func(c r.Term) interface{} { return b.During(a, c)})})})")
...
[false, false, false, false]]]) */
		...
		fmt.Println("About to run line #119: ts.Map(func(a r.Term) interface{} { return ts.Map(func(b r.Term) interface{} { return ts.Map(func(c r.Term) interface{} { return b.During(a, c, r.DuringOpts{LeftBound: 'open', })})})})")
...
[false, false, false, true]]]) */
		...
		fmt.Println("About to run line #139: ts.Map(func(a r.Term) interface{} { return ts.Map(func(b r.Term) interface{} { return ts.Map(func(c r.Term) interface{} { return b.During(a, c, r.DuringOpts{RightBound: 'closed', })})})})")
...
[false, false, false, false]]]) */
		...
		fmt.Println("About to run line #159: ts.Map(func(a r.Term) interface{} { return ts.Map(func(b r.Term) interface{} { return ts.Map(func(c r.Term) interface{} { return b.During(a, c, r.DuringOpts{LeftBound: 'open', RightBound: 'closed', })})})})")
...

	{
		...
		fmt.Println("About to run line #179: ts.Map(func(x r.Term) interface{} { return x.Date().Add(x.TimeOfDay())}).Map(func(x r.Term) interface{} { return x.ToEpochTime()})")
...

	{
		...
		fmt.Println("About to run line #185: r.EpochTime(rt1).Do(r.JS('(function(data){return data})')).ToEpochTime()")
...

	{
		...
		fmt.Println("About to run line #190: r.Do(r.JS('new Date('2012-08-01')')).ToISO8601()")
...

	{
		...
		fmt.Println("About to run line #195: r.Do(r.JS('(function(x){doc = new Object(); doc.date = new Date('2012-08-01'); return doc;})')).AtIndex('date').ToISO8601()")
