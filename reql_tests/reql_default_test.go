...
func (suite *DefaultSuite) TestCases() {
...

    {
        ...
        cursor, err := r.Expr(1).Default(2).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Expr(nil).Default(2).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Expr(map[interface{}]interface{}{}).AtIndex("b").Default(2).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Expr(r.Expr("a").AtIndex("b")).Default(2).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Expr([]interface{}{}).Reduce(func(a r.Term, b r.Term) interface{} { return r.Add(a, b)}).Default(2).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Expr([]interface{}{}).Union([]interface{}{}).Reduce(func(a r.Term, b r.Term) interface{} { return r.Add(a, b)}).Default(2).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Expr("a").Reduce(func(a r.Term, b r.Term) interface{} { return r.Add(a, b)}).Default(2).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Expr(nil).Add(5).Default(2).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Add(5, r.Expr(nil)).Default(2).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Sub(5, r.Expr(nil)).Default(2).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Expr(nil).Sub(5).Default(2).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Expr("a").Add(5).Default(2).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Add(5, r.Expr("a")).Default(2).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Expr("a").Sub(5).Default(2).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Sub(5, r.Expr("a")).Default(2).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Expr(1).Default(r.Error()).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Expr(nil).Default(r.Error()).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Expr(map[interface{}]interface{}{}).AtIndex("b").Default(r.Error()).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Expr([]interface{}{}).Reduce(func(a r.Term, b r.Term) interface{} { return r.Add(a, b)}).Default(r.Error()).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Expr([]interface{}{}).Union([]interface{}{}).Reduce(func(a r.Term, b r.Term) interface{} { return r.Add(a, b)}).Default(r.Error()).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Expr(nil).Add(5).Default(r.Error()).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Add(5, r.Expr(nil)).Default(r.Error()).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Sub(5, r.Expr(nil)).Default(r.Error()).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Expr(nil).Sub(5).Default(r.Error()).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Expr(1).Default(func(e r.Term) interface{} { return e}).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Expr(nil).Default(func(e r.Term) interface{} { return e}).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Expr(map[interface{}]interface{}{}).AtIndex("b").Default(func(e r.Term) interface{} { return e}).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Expr([]interface{}{}).Reduce(func(a r.Term, b r.Term) interface{} { return r.Add(a, b)}).Default(func(e r.Term) interface{} { return e}).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Expr([]interface{}{}).Union([]interface{}{}).Reduce(func(a r.Term, b r.Term) interface{} { return r.Add(a, b)}).Default(func(e r.Term) interface{} { return e}).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Expr(nil).Add(5).Default(func(e r.Term) interface{} { return e}).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Add(5, r.Expr(nil)).Default(func(e r.Term) interface{} { return e}).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Sub(5, r.Expr(nil)).Default(func(e r.Term) interface{} { return e}).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Expr(nil).Sub(5).Default(func(e r.Term) interface{} { return e}).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
    ...
    var arr r.Term = r.Expr([]interface{}{map[interface{}]interface{}{"a": 1, }, map[interface{}]interface{}{"a": nil, }, map[interface{}]interface{}{}}).OrderBy("a")
...

    {
        ...
        cursor, err := arr.Filter(func(x r.Term) interface{} { return x.AtIndex("a").Eq(1)}).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := arr.Filter(func(x r.Term) interface{} { return x.AtIndex("a").Eq(1)}, r.FilterOpts{Default: false, }).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := arr.Filter(func(x r.Term) interface{} { return x.AtIndex("a").Eq(1)}, r.FilterOpts{Default: true, }).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := arr.Filter(func(x r.Term) interface{} { return x.AtIndex("a").Eq(1)}, r.FilterOpts{Default: r.Error(), }).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Expr(false).Do(func(d r.Term) interface{} { return arr.Filter(func(x r.Term) interface{} { return x.AtIndex("a").Eq(1)}, r.FilterOpts{Default: d, })}).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Expr(true).Do(func(d r.Term) interface{} { return arr.Filter(func(x r.Term) interface{} { return x.AtIndex("a").Eq(1)}, r.FilterOpts{Default: d, })}).OrderBy("a").Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := arr.Filter(func(x r.Term) interface{} { return x.AtIndex("a").Default(0).Eq(1)}).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := arr.Filter(func(x r.Term) interface{} { return x.AtIndex("a").Default(1).Eq(1)}).OrderBy("a").Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := arr.Filter(func(x r.Term) interface{} { return x.AtIndex("a").Default(r.Error()).Eq(1)}).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Expr(0).Do(func(i r.Term) interface{} { return arr.Filter(func(x r.Term) interface{} { return x.AtIndex("a").Default(i).Eq(1)})}).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Expr(1).Do(func(i r.Term) interface{} { return arr.Filter(func(x r.Term) interface{} { return x.AtIndex("a").Default(i).Eq(1)})}).OrderBy("a").Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := arr.Filter(func(x r.Term) interface{} { return r.Or(x.AtIndex("a").Eq(1), x.AtIndex("a").AtIndex("b").Eq(2))}).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := arr.Filter(func(x r.Term) interface{} { return r.Or(x.AtIndex("a").Eq(1), x.AtIndex("a").AtIndex("b").Eq(2))}, r.FilterOpts{Default: false, }).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := arr.Filter(func(x r.Term) interface{} { return r.Or(x.AtIndex("a").Eq(1), x.AtIndex("a").AtIndex("b").Eq(2))}, r.FilterOpts{Default: true, }).OrderBy("a").Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := arr.Filter(func(x r.Term) interface{} { return r.Or(x.AtIndex("a").Eq(1), x.AtIndex("a").AtIndex("b").Eq(2))}, r.FilterOpts{Default: r.Error(), }).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.TableCreate("default_test").Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Table("default_test").Insert(arr).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
    ...
    var tbl r.Term = r.Table("default_test").OrderBy("a").Pluck("a")
...

    {
        ...
        cursor, err := tbl.Filter(func(x r.Term) interface{} { return x.AtIndex("a").Eq(1)}).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := tbl.Filter(func(x r.Term) interface{} { return x.AtIndex("a").Eq(1)}, r.FilterOpts{Default: false, }).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := tbl.Filter(func(x r.Term) interface{} { return x.AtIndex("a").Eq(1)}, r.FilterOpts{Default: true, }).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := tbl.Filter(func(x r.Term) interface{} { return x.AtIndex("a").Eq(1)}, r.FilterOpts{Default: r.Error(), }).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Expr(false).Do(func(d r.Term) interface{} { return tbl.Filter(func(x r.Term) interface{} { return x.AtIndex("a").Eq(1)}, r.FilterOpts{Default: d, })}).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Expr(true).Do(func(d r.Term) interface{} { return tbl.Filter(func(x r.Term) interface{} { return x.AtIndex("a").Eq(1)}, r.FilterOpts{Default: d, })}).OrderBy("a").Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := tbl.Filter(func(x r.Term) interface{} { return x.AtIndex("a").Default(0).Eq(1)}).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := tbl.Filter(func(x r.Term) interface{} { return x.AtIndex("a").Default(1).Eq(1)}).OrderBy("a").Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := tbl.Filter(func(x r.Term) interface{} { return x.AtIndex("a").Default(r.Error()).Eq(1)}).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Expr(0).Do(func(i r.Term) interface{} { return tbl.Filter(func(x r.Term) interface{} { return x.AtIndex("a").Default(i).Eq(1)})}).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Expr(1).Do(func(i r.Term) interface{} { return tbl.Filter(func(x r.Term) interface{} { return x.AtIndex("a").Default(i).Eq(1)})}).OrderBy("a").Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := tbl.Filter(func(x r.Term) interface{} { return r.Or(x.AtIndex("a").Eq(1), x.AtIndex("a").AtIndex("b").Eq(2))}).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := tbl.Filter(func(x r.Term) interface{} { return r.Or(x.AtIndex("a").Eq(1), x.AtIndex("a").AtIndex("b").Eq(2))}, r.FilterOpts{Default: false, }).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := tbl.Filter(func(x r.Term) interface{} { return r.Or(x.AtIndex("a").Eq(1), x.AtIndex("a").AtIndex("b").Eq(2))}, r.FilterOpts{Default: true, }).OrderBy("a").Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := tbl.Filter(func(x r.Term) interface{} { return r.Or(x.AtIndex("a").Eq(1), x.AtIndex("a").AtIndex("b").Eq(2))}, r.FilterOpts{Default: r.Error(), }).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.TableDrop("default_test").Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
