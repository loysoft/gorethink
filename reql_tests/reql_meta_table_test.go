...
func (suite *MetaTableSuite) TestCases() {
...

    {
        ...
        cursor, err := db.TableList().Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.DB("rethinkdb").Info().Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...
'indexes':[],'primary_key':'id'}) */
        ...
        cursor, err := r.DB("rethinkdb").Table("stats").Info().Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := db.TableCreate("a").Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := db.TableCreate("b").Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := db.TableDrop("a").Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := db.TableDrop("b").Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := db.TableCreate("ab", r.TableCreateOpts{Durability: "soft", }).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := db.TableDrop("ab").Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := db.TableCreate("ab", r.TableCreateOpts{Durability: "hard", }).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := db.TableCreate("ab", r.TableCreateOpts{Durability: "fake", }).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := db.TableCreate("ab", r.TableCreateOpts{PrimaryKey: "bar", PrimaryReplicaTag: "default", }).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
    	...
    	suite.T().Log("About to run line #93: db.Table('a').Reconfigure()")

        cursor, err := db.Table("a").Reconfigure().Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
    	...
    	suite.T().Log("About to run line #98: db.Table('a').Reconfigure()")
...

    {
    	...
    	suite.T().Log("About to run line #103: db.Table('a').Reconfigure()")
...

    {
    	...
    	suite.T().Log("About to run line #108: db.Table('a').Reconfigure()")
...

    {
    	...
    	suite.T().Log("About to run line #113: db.Table('a').Reconfigure()")
...

    {
    	...
    	suite.T().Log("About to run line #118: db.Table('a').Reconfigure()")
...

    {
    	...
    	suite.T().Log("About to run line #123: db.Table('a').Reconfigure()")
...

    {
        ...
        cursor, err := db.TableCreate("foo").Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := db.TableDrop("foo").Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
    	...
    	suite.T().Log("About to run line #161: db.Table('a').Reconfigure()")
...

    {
    	...
    	suite.T().Log("About to run line #166: db.Table('a').Reconfigure()")
...

    {
    	...
    	suite.T().Log("About to run line #171: db.Table('a').Reconfigure()")
...

    {
    	...
    	suite.T().Log("About to run line #176: db.Table('a').Reconfigure()")
...

    {
    	...
    	suite.T().Log("About to run line #181: db.Table('a').Reconfigure()")
...

    {
    	...
    	suite.T().Log("About to run line #186: db.Table('a').Reconfigure()")
...

    {
    	...
    	suite.T().Log("About to run line #191: db.Table('a').Reconfigure()")
...

    {
    	...
    	suite.T().Log("About to run line #196: db.Table('a').Reconfigure()")
...

    {
    	...
    	suite.T().Log("About to run line #201: db.Reconfigure()")

        cursor, err := db.Reconfigure().Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
    	...
    	suite.T().Log("About to run line #206: db.Table('a').Reconfigure()")
...

    {
    	...
    	suite.T().Log("About to run line #211: db.Table('a').Reconfigure()")
...

    {
    	...
    	suite.T().Log("About to run line #217: db.Table('a').Reconfigure()")
...

    {
    	...
    	suite.T().Log("About to run line #222: db.Table('a').Wait()")

        cursor, err := db.Table("a").Wait().Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := db.Table("a").Insert([]interface{}{map[interface{}]interface{}{"id": 1, }, map[interface{}]interface{}{"id": 2, }, map[interface{}]interface{}{"id": 3, }, map[interface{}]interface{}{"id": 4, }}).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
    	...
    	suite.T().Log("About to run line #233: db.Table('a').Reconfigure()")
...

    {
    	...
    	suite.T().Log("About to run line #238: db.Table('a').Reconfigure()")
...

    {
    	...
    	suite.T().Log("About to run line #244: db.Table('a').Wait()")
...

    {
    	...
    	suite.T().Log("About to run line #251: db.Wait()")

        cursor, err := db.Wait().Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
    ...
    {
        // meta/table.yaml line #258
        /* err('AttributeError', "'module' object has no attribute 'wait'", []) */
        var expected_ Err = err("AttributeError", "'module' object has no attribute 'wait'")
        /* r.wait() */

    	suite.T().Log("About to run line #258: r.Wait()")
...

    {
        ...
        cursor, err := db.TableCreate("c").Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
    	...
    	suite.T().Log("About to run line #279: db.Reconfigure()")
...

    {
    	...
    	suite.T().Log("About to run line #284: db.Reconfigure()")
...

    {
    	...
    	suite.T().Log("About to run line #289: db.Reconfigure()")
...

    {
    	...
    	suite.T().Log("About to run line #294: db.Reconfigure()")
...

    {
    	...
    	suite.T().Log("About to run line #299: db.Reconfigure()")
...

    {
        ...
        cursor, err := db.TableDrop("c").Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.DBCreate("test2").Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := db.TableCreate("testA").Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := db.TableCreate("testB").Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := db2.TableCreate("test2B").Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Table("testA").Config().Pluck("db", "name").Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Table("doesntexist").Config().Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Table("test2B").Config().Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.DB("rethinkdb").Table("table_config").Filter(map[interface{}]interface{}{"name": "testA", }).Nth(0).Eq(r.Table("testA").Config()).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.DB("rethinkdb").Table("table_status").Filter(map[interface{}]interface{}{"name": "testA", }).Nth(0).Eq(r.Table("testA").Status()).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.DB("rethinkdb").Table("table_config", r.TableOpts{IdentifierFormat: "uuid", }).Nth(0).AtIndex("db").Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Table("testA", r.TableOpts{IdentifierFormat: "uuid", }).Count().Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
    ...
    {
        // meta/table.yaml line #349
        /* err('AttributeError', "'module' object has no attribute 'wait'", []) */
        var expected_ Err = err("AttributeError", "'module' object has no attribute 'wait'")
        /* r.wait(wait_for='all_replicas_ready', timeout=5) */

    	suite.T().Log("About to run line #349: r.Wait()")

        actual := r.Wait()

    	assertCompare(suite.T(), expected_, actual)
        suite.T().Log("Finished running line #349")
    }

    {
        ...
        cursor, err := db.TableDrop("testA").Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := db.TableDrop("testB").Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.DBDrop("test2").Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
