...
func (suite *TimesTimezonesSuite) SetupTest() {
	fmt.Println("Setting up TimesTimezonesSuite")
...
func (suite *TimesTimezonesSuite) TearDownSuite() {
	fmt.Println("Tearing down TimesTimezonesSuite")
...
func (suite *TimesTimezonesSuite) TestCases() {
	fmt.Println("Running TimesTimezonesSuite: Test basic timezone manipulation")



	// times/timezones.yaml line #3
	// t1 = r.time(2013, r.july, 29, 23, 30, 0, "+00:00")
	fmt.Println("Possibly executing: var t1 r.Term = r.Time(2013, r.July, 29, 23, 30, 0, '+00:00')")
	...
	fmt.Println("Possibly executing: var tutc1 r.Term = t1.InTimezone('Z')")
	...
	fmt.Println("Possibly executing: var tutc2 r.Term = t1.InTimezone('+00:00')")
	...
	fmt.Println("Possibly executing: var tutc3 r.Term = t1.InTimezone('+00')")
	...
	fmt.Println("Possibly executing: var tutcs r.Term = r.Expr([]interface{}{tutc1, tutc2, tutc3})")
	...
	fmt.Println("Possibly executing: var tm1 r.Term = t1.InTimezone('-00:59')")
	...
	fmt.Println("Possibly executing: var tm2 r.Term = t1.InTimezone('-01:00')")
	...
	fmt.Println("Possibly executing: var tm3 r.Term = t1.InTimezone('-01:01')")
	...
	fmt.Println("Possibly executing: var tms r.Term = r.Expr([]interface{}{tm1, tm2, tm3})")
	...
	fmt.Println("Possibly executing: var tp1 r.Term = t1.InTimezone('+00:59')")
	...
	fmt.Println("Possibly executing: var tp2 r.Term = t1.InTimezone('+01:00')")
	...
	fmt.Println("Possibly executing: var tp3 r.Term = t1.InTimezone('+01:01')")
	...
	fmt.Println("Possibly executing: var tps r.Term = r.Expr([]interface{}{tp1, tp2, tp3})")
	...
	fmt.Println("Possibly executing: var ts r.Term = tutcs.Union(tms).Union(tps).Union([]interface{}{t1})")
...

	{
		...
		fmt.Println("About to run line #23: tutcs.Map(func(x r.Term) interface{} { return []interface{}{x.Timezone(), x.Day()}})")
...

	{
		...
		fmt.Println("About to run line #27: tms.Map(func(x r.Term) interface{} { return []interface{}{x.Timezone(), x.Day()}})")
...

	{
		...
		fmt.Println("About to run line #31: tps.Map(func(x r.Term) interface{} { return []interface{}{x.Timezone(), x.Day()}})")
...

	{
		...
		fmt.Println("About to run line #38: ts.ConcatMap(func(x r.Term) interface{} { return ts.Map(func(y r.Term) interface{} { return r.Sub(x, y)})}).Distinct()")
...

	{
		...
		fmt.Println("About to run line #44: r.Now().InTimezone('')")
...

	{
		...
		fmt.Println("About to run line #47: r.Now().InTimezone('-00')")
...

	{
		...
		fmt.Println("About to run line #50: r.Now().InTimezone('-00:00')")
...

	{
		...
		fmt.Println("About to run line #53: r.Now().InTimezone('UTC+00')")
...

	{
		...
		fmt.Println("About to run line #56: r.Now().InTimezone('+00:60')")
...

	{
		...
		fmt.Println("About to run line #59: r.Now().InTimezone('+25:00')")
...

	{
		...
		fmt.Println("About to run line #63: r.Time(2013, 1, 1, '')")
...

	{
		...
		fmt.Println("About to run line #66: r.Time(2013, 1, 1, '-00')")
...

	{
		...
		fmt.Println("About to run line #69: r.Time(2013, 1, 1, '-00:00')")
...

	{
		...
		fmt.Println("About to run line #72: r.Time(2013, 1, 1, 'UTC+00')")
...

	{
		...
		fmt.Println("About to run line #75: r.Time(2013, 1, 1, '+00:60')")
...

	{
		...
		fmt.Println("About to run line #78: r.Time(2013, 1, 1, '+25:00')")
...

	{
		...
		fmt.Println("About to run line #81: r.EpochTime(1436428422.339).InTimezone('-08:00').Date().ToISO8601()")
...

	{
		...
		fmt.Println("About to run line #85: r.EpochTime(1436428422.339).InTimezone('-07:00').Date().ToISO8601()")
