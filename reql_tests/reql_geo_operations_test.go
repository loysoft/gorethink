...
func (suite *GeoOperationsSuite) TestCases() {
...

    {
        ...
        cursor, err := r.Distance(r.Point(-122, 37), r.Point(-123, 37)).CoerceTo("STRING").Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Distance(r.Point(-122, 37), r.Point(-122, 36)).CoerceTo("STRING").Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Distance(r.Point(-122, 37), r.Point(-122, 36)).Eq(r.Distance(r.Point(-122, 36), r.Point(-122, 37))).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Point(-122, 37).Distance(r.Point(-123, 37)).CoerceTo("STRING").Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
    ...
    var someDist r.Term = r.Distance(r.Point(-122, 37), r.Point(-123, 37))
...

    {
        ...
        cursor, err := someDist.Eq(r.Distance(r.Point(-122, 37), r.Point(-123, 37), r.DistanceOpts{Unit: "m", })).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := someDist.Mul(r.Div(1.0, 1000.0)).Eq(r.Distance(r.Point(-122, 37), r.Point(-123, 37), r.DistanceOpts{Unit: "km", })).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := someDist.Mul(r.Div(1.0, 1609.344)).Eq(r.Distance(r.Point(-122, 37), r.Point(-123, 37), r.DistanceOpts{Unit: "mi", })).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := someDist.Mul(r.Div(1.0, 0.3048)).Eq(r.Distance(r.Point(-122, 37), r.Point(-123, 37), r.DistanceOpts{Unit: "ft", })).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := someDist.Mul(r.Div(1.0, 1852.0)).Eq(r.Distance(r.Point(-122, 37), r.Point(-123, 37), r.DistanceOpts{Unit: "nm", })).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := someDist.Eq(r.Distance(r.Point(-122, 37), r.Point(-123, 37), r.DistanceOpts{GeoSystem: "WGS84", })).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := someDist.Div(10).Eq(r.Distance(r.Point(-122, 37), r.Point(-123, 37), r.DistanceOpts{GeoSystem: map[interface{}]interface{}{"a": 637813.7, "f": r.Div(1.0, 298.257223563), }, })).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Distance(r.Point(-122, 37), r.Point(-123, 37), r.DistanceOpts{GeoSystem: "unit_sphere", }).CoerceTo("STRING").Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Distance(r.Point(0, 0), r.Point(0, 0)).CoerceTo("STRING").Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Distance(r.Point(0, 0), r.Point(180, 0)).Mul(2).CoerceTo("STRING").Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Distance(r.Point(0, -90), r.Point(0, 90)).Mul(2).CoerceTo("STRING").Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Distance(r.Point(0, 0), r.Line([]interface{}{0, 0}, []interface{}{0, 1})).CoerceTo("STRING").Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Distance(r.Line([]interface{}{0, 0}, []interface{}{0, 1}), r.Point(0, 0)).CoerceTo("STRING").Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Distance(r.Point(0, 0), r.Line([]interface{}{0.1, 0}, []interface{}{1, 0})).Eq(r.Distance(r.Point(0, 0), r.Point(0.1, 0))).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Distance(r.Point(0, 0), r.Line([]interface{}{5, -1}, []interface{}{4, 2})).CoerceTo("STRING").Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Distance(r.Point(0, 0), r.Polygon([]interface{}{5, -1}, []interface{}{4, 2}, []interface{}{10, 10})).CoerceTo("STRING").Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Distance(r.Point(0, 0), r.Polygon([]interface{}{0, -1}, []interface{}{0, 1}, []interface{}{10, 10})).CoerceTo("STRING").Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Distance(r.Point(0.5, 0.5), r.Polygon([]interface{}{0, -1}, []interface{}{0, 1}, []interface{}{10, 10})).CoerceTo("STRING").Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Circle([]interface{}{0, 0}, 1, r.CircleOpts{Fill: false, }).Eq(r.Circle([]interface{}{0, 0}, 1, r.CircleOpts{Fill: true, })).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Circle([]interface{}{0, 0}, 1, r.CircleOpts{Fill: false, }).Fill().Eq(r.Circle([]interface{}{0, 0}, 1, r.CircleOpts{Fill: true, })).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Polygon([]interface{}{0, 0}, []interface{}{1, 0}, []interface{}{1, 1}, []interface{}{0, 1}).PolygonSub(r.Polygon([]interface{}{0.1, 0.1}, []interface{}{0.9, 0.1}, []interface{}{0.9, 0.9}, []interface{}{0.1, 0.9})).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Polygon([]interface{}{0, 0}, []interface{}{1, 0}, []interface{}{1, 1}, []interface{}{0, 1}).PolygonSub(r.Polygon([]interface{}{0.1, 0.9}, []interface{}{0.9, 0.0}, []interface{}{0.9, 0.9}, []interface{}{0.1, 0.9})).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Polygon([]interface{}{0, 0}, []interface{}{1, 0}, []interface{}{1, 1}, []interface{}{0, 1}).PolygonSub(r.Polygon([]interface{}{0, 0}, []interface{}{2, 0}, []interface{}{2, 2}, []interface{}{0, 2})).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Polygon([]interface{}{0, 0}, []interface{}{1, 0}, []interface{}{1, 1}, []interface{}{0, 1}).PolygonSub(r.Polygon([]interface{}{0, -2}, []interface{}{1, -2}, []interface{}{-1, 1}, []interface{}{0, -1})).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Polygon([]interface{}{0, 0}, []interface{}{1, 0}, []interface{}{1, 1}, []interface{}{0, 1}).PolygonSub(r.Polygon([]interface{}{0, -1}, []interface{}{1, -1}, []interface{}{1, 0}, []interface{}{0, 0})).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Polygon([]interface{}{0, 0}, []interface{}{1, 0}, []interface{}{1, 1}, []interface{}{0, 1}).PolygonSub(r.Polygon([]interface{}{0.1, -1}, []interface{}{0.9, -1}, []interface{}{0.9, 0.5}, []interface{}{0.1, 0.5})).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Polygon([]interface{}{0, 0}, []interface{}{1, 0}, []interface{}{1, 1}, []interface{}{0, 1}).PolygonSub(r.Polygon([]interface{}{0, 0}, []interface{}{0.1, 0.9}, []interface{}{0.9, 0.9}, []interface{}{0.9, 0.1})).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Polygon([]interface{}{0, 0}, []interface{}{1, 0}, []interface{}{1, 1}, []interface{}{0, 1}).PolygonSub(r.Polygon([]interface{}{0, 0}, []interface{}{0.1, 0.9}, []interface{}{0.9, 0.9}, []interface{}{0.9, 0.1}).PolygonSub(r.Polygon([]interface{}{0.2, 0.2}, []interface{}{0.5, 0.8}, []interface{}{0.8, 0.2}))).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Polygon([]interface{}{0, 0}, []interface{}{1, 0}, []interface{}{1, 1}, []interface{}{0, 1}).PolygonSub(r.Line([]interface{}{0, 0}, []interface{}{0.9, 0.1}, []interface{}{0.9, 0.9}, []interface{}{0.1, 0.9})).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
