...
func (suite *TransformObjectSuite) TestCases() {
    ...
    var obj r.Term = r.Expr(map[interface{}]interface{}{"a": 1, "b": 2, "c": "str", "d": nil, "e": map[interface{}]interface{}{"f": "buzz", }, })
    ...
    var o r.Term = r.Expr(map[interface{}]interface{}{"a": map[interface{}]interface{}{"b": 1, "c": 2, }, "d": 3, })
