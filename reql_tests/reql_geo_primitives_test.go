...
func (suite *GeoPrimitivesSuite) TestCases() {
...

    {
        ...
        cursor, err := r.Circle([]interface{}{0, 0}, 1, r.CircleOpts{NumVertices: 3, }).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Circle(r.Point(0, 0), 1, r.CircleOpts{NumVertices: 3, }).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Circle([]interface{}{0, 0}, 1, r.CircleOpts{NumVertices: 3, Fill: false, }).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Circle([]interface{}{0, 0}, 14000000, r.CircleOpts{NumVertices: 3, }).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Circle([]interface{}{0, 0}, 1, r.CircleOpts{NumVertices: 3, GeoSystem: "WGS84", }).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Circle([]interface{}{0, 0}, 2, r.CircleOpts{NumVertices: 3, GeoSystem: "unit_sphere", }).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Circle([]interface{}{0, 0}, 0.1, r.CircleOpts{NumVertices: 3, GeoSystem: "unit_sphere", }).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Circle([]interface{}{0, 0}, r.Div(1.0, 1000.0), r.CircleOpts{NumVertices: 3, Unit: "km", }).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Circle([]interface{}{0, 0}, r.Div(1.0, 1609.344), r.CircleOpts{NumVertices: 3, Unit: "mi", }).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
