...
func (suite *GeoIndexingSuite) SetupTest() {
	fmt.Println("Setting up GeoIndexingSuite")
...
func (suite *GeoIndexingSuite) TearDownSuite() {
	fmt.Println("Tearing down GeoIndexingSuite")
...
func (suite *GeoIndexingSuite) TestCases() {
	fmt.Println("Running GeoIndexingSuite: Test ReQL interface to geo indexes")
	...
	fmt.Println("Possibly executing: var rows []interface{} = []interface{}{map[interface{}]interface{}{'id': 0, 'g': r.Point(10, 10), 'm': []interface{}{r.Point(0, 0), r.Point(1, 0), r.Point(2, 0)}, }, map[interface{}]interface{}{'id': 1, 'g': r.Polygon([]interface{}{0, 0}, []interface{}{0, 1}, []interface{}{1, 1}, []interface{}{1, 0}), }, map[interface{}]interface{}{'id': 2, 'g': r.Line([]interface{}{2e-06, -1}, []interface{}{-1e-06, 1}), }}")
...

	{
		...
		fmt.Println("About to run line #8: tbl.Insert(rows)")
...

	{
		...
		fmt.Println("About to run line #12: tbl.IndexCreate('g', r.IndexCreateOpts{Geo: true, })")
...

	{
		...
		fmt.Println("About to run line #16: tbl.IndexCreate('m', r.IndexCreateOpts{Geo: true, Multi: true, })")
...

	{
		...
		fmt.Println("About to run line #19: tbl.IndexCreate('other')")
...

	{
		...
		fmt.Println("About to run line #23: tbl.IndexCreateFunc('point_det', func(x r.Term) interface{} { return r.Point(x, x)})")
...

	{
		...
		fmt.Println("About to run line #27: tbl.IndexWait()")
...

	{
		...
		fmt.Println("About to run line #32: tbl.IndexCreateFunc('point_det', func(x r.Term) interface{} { return r.Line(x, x)})")
...

	{
		...
		fmt.Println("About to run line #37: tbl.GetIntersecting(r.Point(0, 0), r.GetIntersectingOpts{Index: 'other', }).Count()")
...

	{
		...
		fmt.Println("About to run line #41: tbl.GetIntersecting(r.Point(0, 0), r.GetIntersectingOpts{Index: 'missing', }).Count()")
...

	{
		...
		fmt.Println("About to run line #44: tbl.GetIntersecting(r.Point(0, 0)).Count()")
...

	{
		...
		fmt.Println("About to run line #47: tbl.GetAllByIndex('g', 0).Count()")
...

	{
		...
		fmt.Println("About to run line #51: tbl.Between(0, 1, r.BetweenOpts{Index: 'g', }).Count()")
...

	{
		...
		fmt.Println("About to run line #55: tbl.OrderBy(r.OrderByOpts{Index: 'g', }).Count()")
...

	{
		...
		fmt.Println("About to run line #77: tbl.GetIntersecting(r.Point(0, 0), r.GetIntersectingOpts{Index: 'id', }).Count()")
...

	{
		...
		fmt.Println("About to run line #82: tbl.GetIntersecting(r.Point(0, 0), r.GetIntersectingOpts{Index: 'g', }).Count()")
...

	{
		...
		fmt.Println("About to run line #86: tbl.GetIntersecting(r.Point(10, 10), r.GetIntersectingOpts{Index: 'g', }).Count()")
...

	{
		...
		fmt.Println("About to run line #90: tbl.GetIntersecting(r.Point(0.5, 0.5), r.GetIntersectingOpts{Index: 'g', }).Count()")
...

	{
		...
		fmt.Println("About to run line #94: tbl.GetIntersecting(r.Point(20, 20), r.GetIntersectingOpts{Index: 'g', }).Count()")
...

	{
		...
		fmt.Println("About to run line #98: tbl.GetIntersecting(r.Polygon([]interface{}{0, 0}, []interface{}{1, 0}, []interface{}{1, 1}, []interface{}{0, 1}), r.GetIntersectingOpts{Index: 'g', }).Count()")
...

	{
		...
		fmt.Println("About to run line #102: tbl.GetIntersecting(r.Line([]interface{}{0, 0}, []interface{}{10, 10}), r.GetIntersectingOpts{Index: 'g', }).Count()")
...

	{
		...
		fmt.Println("About to run line #106: tbl.GetIntersecting(r.Point(0, 0), r.GetIntersectingOpts{Index: 'g', }).TypeOf()")
...

	{
		...
		fmt.Println("About to run line #110: tbl.GetIntersecting(r.Point(0, 0), r.GetIntersectingOpts{Index: 'g', }).Filter(true).TypeOf()")
...

	{
		...
		fmt.Println("About to run line #114: tbl.GetIntersecting(r.Point(0, 0), r.GetIntersectingOpts{Index: 'g', }).Map(r.Row).TypeOf()")
...

	{
		...
		fmt.Println("About to run line #119: tbl.GetIntersecting(r.Point(0, 0), r.GetIntersectingOpts{Index: 'm', }).Count()")
...

	{
		...
		fmt.Println("About to run line #123: tbl.GetIntersecting(r.Point(1, 0), r.GetIntersectingOpts{Index: 'm', }).Count()")
...

	{
		...
		fmt.Println("About to run line #127: tbl.GetIntersecting(r.Point(2, 0), r.GetIntersectingOpts{Index: 'm', }).Count()")
...

	{
		...
		fmt.Println("About to run line #131: tbl.GetIntersecting(r.Point(3, 0), r.GetIntersectingOpts{Index: 'm', }).Count()")
...

	{
		...
		fmt.Println("About to run line #136: tbl.GetIntersecting(r.Polygon([]interface{}{0, 0}, []interface{}{0, 1}, []interface{}{1, 1}, []interface{}{1, 0}), r.GetIntersectingOpts{Index: 'm', }).Count()")
...

	{
		...
		fmt.Println("About to run line #142: tbl.GetNearest(r.Point(0, 0), r.GetNearestOpts{Index: 'other', })")
...

	{
		...
		fmt.Println("About to run line #146: tbl.GetNearest(r.Point(0, 0), r.GetNearestOpts{Index: 'missing', })")
...

	{
		...
		fmt.Println("About to run line #149: tbl.GetNearest(r.Point(0, 0))")
...

	{
		...
		fmt.Println("About to run line #170: tbl.GetNearest(r.Point(0, 0), r.GetNearestOpts{Index: 'id', }).Count()")

		runAndAssert(suite.Suite, expected_, tbl.GetNearest(r.Point(0, 0), r.GetNearestOpts{Index: "id", }).Count(), suite.session, r.RunOpts{
			GroupFormat: "map",
			GeometryFormat: "raw",
		})
		fmt.Println("Finished running line #170")
	}

	{
		...
		fmt.Println("About to run line #175: tbl.GetNearest(r.Point(0, 0), r.GetNearestOpts{Index: 'g', }).Pluck('dist', map[interface{}]interface{}{'doc': 'id', })")
...

	{
		...
		fmt.Println("About to run line #179: tbl.GetNearest(r.Point(-1e-06, 1), r.GetNearestOpts{Index: 'g', }).Pluck('dist', map[interface{}]interface{}{'doc': 'id', })")
...

	{
		...
		fmt.Println("About to run line #183: tbl.GetNearest(r.Point(0, 0), r.GetNearestOpts{Index: 'g', MaxDist: 1565110, }).Pluck('dist', map[interface{}]interface{}{'doc': 'id', })")
...

	{
		...
		fmt.Println("About to run line #187: tbl.GetNearest(r.Point(0, 0), r.GetNearestOpts{Index: 'g', MaxDist: 1565110, MaxResults: 2, }).Pluck('dist', map[interface{}]interface{}{'doc': 'id', })")
...

	{
		...
		fmt.Println("About to run line #191: tbl.GetNearest(r.Point(0, 0), r.GetNearestOpts{Index: 'g', MaxDist: 10000000, }).Pluck('dist', map[interface{}]interface{}{'doc': 'id', })")
...

	{
		...
		fmt.Println("About to run line #195: tbl.GetNearest(r.Point(0, 0), r.GetNearestOpts{Index: 'g', MaxDist: 1566, Unit: 'km', }).Pluck('dist', map[interface{}]interface{}{'doc': 'id', })")
...

	{
		...
		fmt.Println("About to run line #198: tbl.GetNearest(r.Point(0, 0), r.GetNearestOpts{Index: 'g', MaxDist: 1, GeoSystem: 'unit_sphere', }).Pluck('dist', map[interface{}]interface{}{'doc': 'id', })")
...

	{
		...
		fmt.Println("About to run line #202: tbl.GetNearest(r.Point(0, 0), r.GetNearestOpts{Index: 'g', }).TypeOf()")
...

	{
		...
		fmt.Println("About to run line #206: tbl.GetNearest(r.Point(0, 0), r.GetNearestOpts{Index: 'g', }).Map(r.Row).TypeOf()")
