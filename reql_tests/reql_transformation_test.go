...
func (suite *TransformationSuite) TestCases() {
    ...
    var ccm r.Term = tbl.ConcatMap(func(row r.Term) interface{} { return []interface{}{row.AtIndex("a"), row.AtIndex("a").Add(1).Mod(4)}})
    ...
    var arr r.Term = r.Expr([]interface{}{1, 2, 3, 4, 5})
