...
func (suite *MathLogicFloorCeilRoundSuite) TestCases() {
...

    {
        ...
        cursor, err := r.Floor(1.0).TypeOf().Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Floor(1.0).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Expr(1.0).Floor().Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Floor(0.5).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Floor(1.5).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Expr("X").Floor().Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Ceil(1.0).TypeOf().Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Ceil(1.0).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Expr(1.0).Ceil().Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Ceil(0.5).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Ceil(1.5).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Expr("X").Ceil().Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Round(1.0).TypeOf().Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Round(1.0).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Expr(1.0).Round().Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Round(0.5).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Round(0.0).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Round(10.0).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Round(1000000000.0).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Round(1e+20).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Round(0.1).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Round(1.1).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Round(10.1).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Round(1000000000.1).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Round(0.9).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Round(9.9).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Round(999999999.9).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Expr("X").Round().Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
