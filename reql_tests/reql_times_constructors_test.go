...
func (suite *TimesConstructorsSuite) TestCases() {
    ...
    var dates []interface{} = []interface{}{"2013", "2013-01", "2013-01-01", "20130101", "2013-001", "2013001"}
    ...
    var times []interface{} = []interface{}{"13", "13:00", "1300", "13:00:00", "13:00:00.000000", "130000.000000"}
    ...
    var tzs []interface{} = []interface{}{"Z", "+00", "+0000", "+00:00"}
    ...
    var cdt []interface{} = []interface{}{cdate + "T" + ctime + ctz}
    ...
    var bad_dates []interface{} = []interface{}{"201301", "2013-0101", "2a13", "2013+01", "2013-01-01.1"}
    ...
    var bad_times []interface{} = []interface{}{"a3", "13:0000", "13:000", "13:00.00", "130000.00000000a"}
    ...
    var bad_tzs []interface{} = []interface{}{"X", "-7", "-07:-1", "+07+01", "PST", "UTC", "Z+00"}
