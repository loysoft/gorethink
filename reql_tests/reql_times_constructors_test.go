...
func (suite *TimesConstructorsSuite) SetupTest() {
	fmt.Println("Setting up TimesConstructorsSuite")
...
func (suite *TimesConstructorsSuite) TearDownSuite() {
	fmt.Println("Tearing down TimesConstructorsSuite")
...
func (suite *TimesConstructorsSuite) TestCases() {
	fmt.Println("Running TimesConstructorsSuite: Test basic time arithmetic")
...

	{
		...
		fmt.Println("About to run line #5: r.Expr(r.EpochTime(896571240))")
...

	{
		...
		fmt.Println("About to run line #11: r.Expr(map[interface{}]interface{}{'stuff': r.EpochTime(896571240), 'more': []interface{}{r.EpochTime(996571240)}, })")
...

	{
		...
		fmt.Println("About to run line #17: r.Expr([]interface{}{r.EpochTime(796571240), r.EpochTime(896571240), map[interface{}]interface{}{'stuff': r.EpochTime(996571240), }})")
...

	{
		...
		fmt.Println("About to run line #23: r.Expr(map[interface{}]interface{}{'nested': map[interface{}]interface{}{'time': r.EpochTime(896571240), }, })")
...

	{
		...
		fmt.Println("About to run line #29: r.Expr([]interface{}{1, 'two', []interface{}{'a', r.EpochTime(896571240), 3}})")
...

	{
		...
		fmt.Println("About to run line #35: r.EpochTime(1).ToEpochTime()")
...

	{
		...
		fmt.Println("About to run line #37: r.EpochTime(-1).ToEpochTime()")
...

	{
		...
		fmt.Println("About to run line #39: r.EpochTime(1.4444445).ToEpochTime()")
...

	{
		...
		fmt.Println("About to run line #42: r.EpochTime(1.4444445).ToISO8601()")
...

	{
		...
		fmt.Println("About to run line #45: r.EpochTime(1.4444445).Seconds()")
...

	{
		...
		fmt.Println("About to run line #48: r.EpochTime(253430000000).Year()")
...

	{
		...
		fmt.Println("About to run line #50: r.EpochTime(253430000000).ToISO8601()")
...

	{
		...
		fmt.Println("About to run line #53: r.EpochTime(253440000000).Year()")
...

	{
		...
		fmt.Println("About to run line #55: r.EpochTime(253440000000).ToEpochTime()")
...

	{
		...
		fmt.Println("About to run line #57: r.EpochTime(-17980000000).Year()")
...

	{
		...
		fmt.Println("About to run line #59: r.EpochTime(-17990000000).Year()")
...

	{
		...
		fmt.Println("About to run line #61: r.EpochTime(-17990000000).ToEpochTime()")
	...
	// cdate = "2013-01-01"
	fmt.Println("Possibly executing: var cdate string = '2013-01-01'")
	...
	fmt.Println("Possibly executing: var dates []interface{} = []interface{}{'2013', '2013-01', '2013-01-01', '20130101', '2013-001', '2013001'}")
	...
	// ctime = "13:00:00"
	fmt.Println("Possibly executing: var ctime string = '13:00:00'")
	...
	fmt.Println("Possibly executing: var times []interface{} = []interface{}{'13', '13:00', '1300', '13:00:00', '13:00:00.000000', '130000.000000'}")
	...
	// ctz = "+00:00"
	fmt.Println("Possibly executing: var ctz string = '+00:00'")
	...
	// tzs = ["Z", "+00", "+0000", "+00:00"]
	fmt.Println("Possibly executing: var tzs []interface{} = []interface{}{'Z', '+00', '+0000', '+00:00'}")
	...
	fmt.Println("Possibly executing: var cdt []interface{} = []interface{}{cdate + 'T' + ctime + ctz}")
	...
	fmt.Println("Possibly executing: var bad_dates []interface{} = []interface{}{'201301', '2013-0101', '2a13', '2013+01', '2013-01-01.1'}")
	...
	fmt.Println("Possibly executing: var bad_times []interface{} = []interface{}{'a3', '13:0000', '13:000', '13:00.00', '130000.00000000a'}")
	...
	fmt.Println("Possibly executing: var bad_tzs []interface{} = []interface{}{'X', '-7', '-07:-1', '+07+01', 'PST', 'UTC', 'Z+00'}")
