...
func (suite *DatumArraySuite) TestCases() {
...

    {
        ...
        cursor, err := r.Expr([]interface{}{}).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Expr([]interface{}{1}).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Expr([]interface{}{1, 2, 3, 4, 5}).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Expr([]interface{}{}).TypeOf().Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Expr([]interface{}{1, 2}).CoerceTo("string").Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Expr([]interface{}{1, 2}).CoerceTo("array").Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Expr([]interface{}{1, 2}).CoerceTo("number").Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Expr([]interface{}{[]interface{}{"a", 1}, []interface{}{"b", 2}}).CoerceTo("object").Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Expr([]interface{}{[]interface{}{}}).CoerceTo("object").Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Expr([]interface{}{[]interface{}{"1", 2, 3}}).CoerceTo("object").Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Expr([]interface{}{r.Expr(1)}).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Expr([]interface{}{1, 3, 4}).InsertAt(1, 2).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Expr([]interface{}{2, 3}).InsertAt(0, 1).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Expr([]interface{}{1, 2, 3}).InsertAt(-1, 4).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Expr([]interface{}{1, 2, 3}).InsertAt(3, 4).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Expr(3).Do(func(x r.Term) interface{} { return r.Expr([]interface{}{1, 2, 3}).InsertAt(x, 4)}).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Expr([]interface{}{1, 2, 3}).InsertAt(4, 5).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Expr([]interface{}{1, 2, 3}).InsertAt(-5, -1).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Expr([]interface{}{1, 2, 3}).InsertAt(1.5, 1).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Expr([]interface{}{1, 2, 3}).InsertAt(nil, 1).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Expr([]interface{}{1, 4}).SpliceAt(1, []interface{}{2, 3}).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Expr([]interface{}{3, 4}).SpliceAt(0, []interface{}{1, 2}).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Expr([]interface{}{1, 2}).SpliceAt(2, []interface{}{3, 4}).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Expr([]interface{}{1, 2}).SpliceAt(-1, []interface{}{3, 4}).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Expr(2).Do(func(x r.Term) interface{} { return r.Expr([]interface{}{1, 2}).SpliceAt(x, []interface{}{3, 4})}).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Expr([]interface{}{1, 2}).SpliceAt(3, []interface{}{3, 4}).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Expr([]interface{}{1, 2}).SpliceAt(-4, []interface{}{3, 4}).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Expr([]interface{}{1, 2, 3}).SpliceAt(1.5, []interface{}{1}).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Expr([]interface{}{1, 2, 3}).SpliceAt(nil, []interface{}{1}).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Expr([]interface{}{1, 4}).SpliceAt(1, 2).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Expr([]interface{}{1, 2, 3, 4}).DeleteAt(0).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Expr(0).Do(func(x r.Term) interface{} { return r.Expr([]interface{}{1, 2, 3, 4}).DeleteAt(x)}).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Expr([]interface{}{1, 2, 3, 4}).DeleteAt(-1).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Expr([]interface{}{1, 2, 3, 4}).DeleteAt(1, 3).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Expr([]interface{}{1, 2, 3, 4}).DeleteAt(4, 4).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Expr([]interface{}{}).DeleteAt(0, 0).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Expr([]interface{}{1, 2, 3, 4}).DeleteAt(1, -1).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Expr([]interface{}{1, 2, 3, 4}).DeleteAt(4).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Expr([]interface{}{1, 2, 3, 4}).DeleteAt(-5).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Expr([]interface{}{1, 2, 3}).DeleteAt(1.5).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Expr([]interface{}{1, 2, 3}).DeleteAt(nil).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Expr([]interface{}{0, 2, 3}).ChangeAt(0, 1).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Expr(1).Do(func(x r.Term) interface{} { return r.Expr([]interface{}{0, 2, 3}).ChangeAt(0, x)}).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Expr([]interface{}{1, 0, 3}).ChangeAt(1, 2).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Expr([]interface{}{1, 2, 0}).ChangeAt(2, 3).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Expr([]interface{}{1, 2, 3}).ChangeAt(3, 4).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Expr([]interface{}{1, 2, 3, 4}).ChangeAt(-5, 1).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Expr([]interface{}{1, 2, 3}).ChangeAt(1.5, 1).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Expr([]interface{}{1, 2, 3}).ChangeAt(nil, 1).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
