...
func (suite *DatumStringSuite) TestCases() {
	...
	var japanese_hello string = "こんにちは"

	{
		...
		cursor, err := r.Expr("str").Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
		})
...

	{
		...
		cursor, err := r.Expr(japanese_hello).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
		})
...

	{
		...
		cursor, err := r.Expr("foo").TypeOf().Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
		})
...

	{
		...
		cursor, err := r.Expr("foo").CoerceTo("string").Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
		})
...

	{
		...
		cursor, err := r.Expr("-1.2").CoerceTo("NUMBER").Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
		})
...

	{
		...
		cursor, err := r.Expr("0xa").CoerceTo("NUMBER").Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
		})
...

	{
		...
		cursor, err := r.Expr("inf").CoerceTo("NUMBER").Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
		})
...

	{
		...
		cursor, err := r.Expr("hello, world!").Count().Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
		})
...

	{
		...
		cursor, err := r.Expr(japanese_hello).Count().Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
		})
...

	{
		...
		cursor, err := r.Expr("hello").Slice(1).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
		})
...

	{
		...
		cursor, err := r.Expr("hello").Slice(-4, 3).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
		})
...

	{
		...
		cursor, err := r.Expr("hello").Slice(-99).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
		})
...

	{
		...
		cursor, err := r.Expr("hello").Slice(0).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
		})
...

	{
		...
		cursor, err := r.Expr(japanese_hello).Slice(1).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
		})
...

	{
		...
		cursor, err := r.Expr(japanese_hello).Slice(1, 2).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
		})
...

	{
		...
		cursor, err := r.Expr(japanese_hello).Slice(-3).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
		})
...

	{
		...
		cursor, err := r.Expr("").Split().Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
		})
...

	{
		...
		cursor, err := r.Expr("").Split(nil).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
		})
...

	{
		...
		cursor, err := r.Expr("").Split(nil, 5).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
		})
...

	{
		...
		cursor, err := r.Expr("").Split(" ", 5).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
		})
...

	{
		...
		cursor, err := r.Expr("aaaa bbbb  cccc ").Split().Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
		})
...

	{
		...
		cursor, err := r.Expr("aaaa bbbb  cccc ").Split(nil).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
		})
...

	{
		...
		cursor, err := r.Expr("aaaa bbbb  cccc ").Split("b").Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
		})
...

	{
		...
		cursor, err := r.Expr("aaaa bbbb  cccc ").Split("bb").Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
		})
...

	{
		...
		cursor, err := r.Expr("aaaa bbbb  cccc ").Split(" bbbb  ").Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
		})
...

	{
		...
		cursor, err := r.Expr("aaaa bbbb  cccc b d bb e bbbb f").Split("bb").Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
		})
...

	{
		...
		cursor, err := r.Expr("aaaa bbbb  cccc b d bb e bbbb f").Split(" bbbb  ").Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
		})
...

	{
		...
		cursor, err := r.Expr("aaaa bbbb  cccc ").Split(nil, 3).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
		})
...

	{
		...
		cursor, err := r.Expr("aaaa bbbb  cccc ").Split(" ", 5).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
		})
...

	{
		...
		cursor, err := r.Expr("aaaa bbbb  cccc ").Split("b", 5).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
		})
...

	{
		...
		cursor, err := r.Expr("aaaa bbbb  cccc ").Split("bb", 3).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
		})
...

	{
		...
		cursor, err := r.Expr("aaaa bbbb  cccc ").Split(" bbbb  ", 2).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
		})
...

	{
		...
		cursor, err := r.Expr("aaaa bbbb  cccc b d bb e bbbb f").Split("bb", 6).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
		})
...

	{
		...
		cursor, err := r.Expr("aaaa bbbb  cccc b d bb e bbbb f").Split(" bbbb  ", 2).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
		})
...

	{
		...
		cursor, err := r.Expr("aaaa bbbb  cccc b d bb e bbbb  f").Split(" bbbb  ", 3).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
		})
...

	{
		...
		cursor, err := r.Expr("aaaa bbbb  cccc ").Split(nil, 2).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
		})
...

	{
		...
		cursor, err := r.Expr("a  b  ").Split(nil, 2).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
		})
...

	{
		...
		cursor, err := r.Expr("aaaa bbbb  cccc ").Split(" ", 4).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
		})
...

	{
		...
		cursor, err := r.Expr("aaaa bbbb  cccc ").Split("b", 4).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
		})
...

	{
		...
		cursor, err := r.Expr("aaaa bbbb  cccc ").Split("bb", 2).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
		})
...

	{
		...
		cursor, err := r.Expr("aaaa bbbb  cccc ").Split(" bbbb  ", 1).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
		})
...

	{
		...
		cursor, err := r.Expr("aaaa bbbb  cccc b d bb e bbbb f").Split("bb", 5).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
		})
...

	{
		...
		cursor, err := r.Expr("aaaa bbbb  cccc b d bb e bbbb f").Split(" bbbb  ", 1).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
		})
...

	{
		...
		cursor, err := r.Expr("aaaa bbbb  cccc ").Split(nil, 1).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
		})
...

	{
		...
		cursor, err := r.Expr("aaaa bbbb  cccc ").Split(" ", 2).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
		})
...

	{
		...
		cursor, err := r.Expr("aaaa bbbb  cccc ").Split("b", 2).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
		})
...

	{
		...
		cursor, err := r.Expr("aaaa bbbb  cccc b d bb e bbbb f").Split("bb", 2).Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
		})
...

	{
		...
		cursor, err := r.Expr("abc-dEf-GHJ").Upcase().Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
		})
...

	{
		...
		cursor, err := r.Expr("abc-dEf-GHJ").Downcase().Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
		})
...

	{
		...
		cursor, err := r.Expr("féoo").Split("").Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
		})
...

	{
		...
		cursor, err := r.Expr("féoo").Split("").Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
		})
...

	{
		...
		cursor, err := r.Expr("foo bar\tbaz\nquux\rfred\u000bbarney\u000cwilma").Split().Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
		})
...

	{
		...
		cursor, err := r.Expr("foo\u00a0bar\u2001baz\u2060quux\u2028fred\u2028barney\u2029wilma\u0085betty\u200b").Split().Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
		})
