...
func (suite *JsonSuite) TestCases() {
...

    {
        ...
        cursor, err := r.JSON("[1,2,3]").Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.JSON("1").Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.JSON("{}").Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.JSON("\"foo\"").Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.JSON("[1,2").Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.JSON("[1,2,3]").ToJSON().Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.JSON("{\"foo\":4}").ToJSON().Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.JSON(text).ToJSON().Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Expr(r.MinVal).ToJSON().Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Expr(r.MaxVal).ToJSON().Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Expr(r.MinVal).CoerceTo("string").Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Expr(r.MaxVal).CoerceTo("string").Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Time(2014, 9, 11, "Z").Run(suite.session, r.RunOpts{
			TimeFormat: "raw",
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Time(2014, 9, 11, "Z").ToJSON().Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Point(0, 0).ToJSON().Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
...

    {
        ...
        cursor, err := r.Expr("foo").CoerceTo("binary").ToJSON().Run(suite.session, r.RunOpts{
			GeometryFormat: "raw",
    	})
